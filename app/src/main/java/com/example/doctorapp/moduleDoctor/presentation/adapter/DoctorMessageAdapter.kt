...
class DoctorMessageAdapter(private val context: Context) : BaseReverseAdapterLoadMore<MessageData>(MessageDiffUtil()) {
    ...
    override fun getItemViewType(position: Int): Int {
        return when (getItem(position)) {
            is Message -> {
                if ((getItem(position) as Message).patient != null) {

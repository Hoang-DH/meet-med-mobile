...
import com.example.doctorapp.presentation.diffUtil.SearchDoctorDiffUtil

class SearchDoctorAdapter(
    private val context: Context,
    private val onDoctorClickListener: ((Doctor) -> Unit)? = null
) :
    ListAdapter<Doctor, SearchDoctorAdapter.SearchDoctorViewHolder>(SearchDoctorDiffUtil()) {
